...
const DetailsBlogInWishlist = () => {
    ...
    const [comments, setComments] = useState(blogDetailsInwishlist.comments || []);
    const isCurrentUserBlogOwner = user && user.email === blogDetailsInwishlist.email;
    ...
    const addComment = (e) => {
        ...
        fetch(`http://localhost:5000/wishlist/${blogDetailsInwishlist._id}`, {
          method: 'PUT',
          headers: {
